...
Resumidamente, foram coletos ápices caulinares em 3 diferentes fases do desenvolvimento do maracujá: 
- Juveni
- Adulto
- Reprodutivo
...
O objetivo dessa análise é analisar o número de genes que estão sendo expressos em cada condição. 
Foi então utilizado o diagrama de venn para demonstrar o resultado:
...
```{r genes, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("venn_diagram_genes.png")
```
...
```{r isoforms, echo=FALSE, fig.cap="A caption", out.width = '100%'}
knitr::include_graphics("venn_diagram_isoforms.png")
```
